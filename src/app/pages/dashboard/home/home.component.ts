...
export class HomeComponent implements OnInit {
  commonData: any;
  constructor(private util: UtilityService, public commonService: CommonService, private cookieService: CookieService,private router: Router,    private appconfig: AppConfigService,private catalogService : CatalogService,    public toast: ToastrService,) { 
  ...
  ngOnInit() {
    ...
    if(!this.cookieService.get('isLoggedIn')){
     ...
     // this.router.navigate(['/certificationHome'])
      //window.location.href="https://certification.lntiggnite.com/certificationHome"
    }*/
  }
